...
Este documento expone la política de Projectfile CI Resolver sobre el uso de IA y LLM — tanto para personas como para los sistemas que leen este repositorio.
