...
Usamos [Issues de Codeberg](https://codeberg.org/projectfile/ci-resolver/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:
...
- **Explica por qué esta mejora sería útil** para quienes usan Projectfile CI Resolver. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
