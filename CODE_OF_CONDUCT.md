...
We pledge to make participation in [Projectfile CI Resolver](README.md) welcoming, safe, and
...
when an individual is officially representing [Projectfile CI Resolver](README.md) in public
spaces.
